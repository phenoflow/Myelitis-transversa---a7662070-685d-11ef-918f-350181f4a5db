...
(async () => {
  ...
  await fs.writeFile("myelitis-transversa-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("myelitis-transversa-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
